...
export const ContactSession: React.FC = () => {
  ...
  const [orgType, setOrgType] = useState("Healthcare / Hospital");
  ...
  return (
    <section className="mt-16 pt-12 pb-16 border-t border-slate-800/80">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-950/60 border border-cyan-800/50 text-cyan-300 text-xs font-mono mb-3">
            ...
            <span>Confidential Inquiries & Collaboration</span>
          </div>
          <h2 className="text-2xl sm:text-4xl font-extrabold text-white tracking-tight">
            Deploy A Private Data Clean Room
          </h2>
          <p className="mt-2 text-sm text-slate-400">
            Connect your healthcare network, financial ledger, or enterprise AI pipeline to DataVault AI on Midnight.
          </p>
        </div>
          ...
          <div className="lg:col-span-7 bg-slate-900/90 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl backdrop-blur-xl">
            {submittedReceipt ? (
              <div className="py-8 text-center space-y-4">
                <div className="w-14 h-14 bg-emerald-950 border border-emerald-500/40 rounded-2xl flex items-center justify-center mx-auto text-emerald-400 shadow-lg shadow-emerald-500/20">
                  <CheckCircle className="w-8 h-8" />
                </div>
                <h3 className="text-lg font-bold text-white">Inquiry Encrypted & Received</h3>
                ...
                <div className="p-3 bg-slate-950 rounded-xl border border-slate-800 text-left text-xs space-y-1">
                  <span className="text-[10px] text-slate-500 font-mono block">ENCRYPTED RECEIPT HASH:</span>
                  <code className="text-cyan-300 font-mono break-all text-[11px] block">
                    {submittedReceipt}
                  </code>
                </div>
                <button
                  ...
                  className="px-5 py-2 text-xs font-medium rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-200 transition"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-xs sm:text-sm text-white placeholder-slate-500 focus:outline-none focus:border-cyan-500 transition"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-slate-300 mb-1">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-xs sm:text-sm text-white focus:outline-none focus:border-cyan-500 transition"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-slate-950 border border-slate-800 rounded-xl p-3 text-xs sm:text-sm text-white placeholder-slate-500 focus:outline-none focus:border-cyan-500 transition"
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-cyan-500 via-blue-600 to-indigo-600 hover:from-cyan-400 hover:to-indigo-500 text-white font-semibold text-xs sm:text-sm shadow-xl shadow-cyan-500/20 transition disabled:opacity-50"
                >
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-xl backdrop-blur-xl space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-base font-bold text-white">DataVault AI Protocol</h3>
                  <p className="text-xs text-cyan-400 font-mono">Midnight Builder Challenge Level 3</p>
                </div>
              </div>
              ...
              <div className="pt-3 border-t border-slate-800 space-y-2.5">
                <a
                  ...
                  className="flex items-center justify-between p-3 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-slate-700 text-xs text-slate-200 hover:text-white transition group"
                >
                ...
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="font-semibold">Midnight Documentation</span>
                  </div>
                  <ExternalLink className="w-3.5 h-3.5 text-slate-500 group-hover:text-cyan-400 transition" />
                </a>
              </div>
            ...
            <div className="bg-gradient-to-br from-slate-900 to-slate-950 border border-cyan-800/40 rounded-3xl p-5 shadow-xl text-xs space-y-2">
              ...
              <code className="font-mono text-[10.5px] text-slate-300 break-all block bg-slate-950 p-2.5 rounded-lg border border-slate-800">
                {PREPROD_CONTRACT_ADDRESS}
              </code>
              <p className="text-[11px] text-slate-500">
                Contains 3 deployed circuits: <span className="text-slate-400 font-mono">registerDataset</span>, <span className="text-slate-400 font-mono">requestComputation</span>, <span className="text-slate-400 font-mono">verifyPolicyCompliance</span>.
              </p>
            </div>
          </div>
        </div>
