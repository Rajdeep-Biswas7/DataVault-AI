        ...
        <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-200 dark:border-slate-800">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <div className="w-8 h-8 rounded-xl bg-emerald-100 dark:bg-emerald-950/80 border border-emerald-300 dark:border-emerald-700/50 flex items-center justify-center text-emerald-600 dark:text-emerald-400">
          ...
          <span className="text-xs font-mono font-bold text-emerald-700 dark:text-emerald-400 px-3 py-1 rounded-full bg-emerald-100 dark:bg-emerald-950/60 border border-emerald-300 dark:border-emerald-700/60">
            Node Synchronized
          </span>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
          <div className="bg-white dark:bg-slate-950/90 border border-slate-200 dark:border-slate-800/90 rounded-2xl p-5 hover:border-cyan-500/40 shadow-sm transition">
          ...
          <div className="bg-white dark:bg-slate-950/90 border border-slate-200 dark:border-slate-800/90 rounded-2xl p-5 hover:border-indigo-500/40 shadow-sm transition">
            <span className="text-xs text-slate-500 dark:text-slate-400 font-mono block mb-1">
          ...
          <div className="bg-white dark:bg-slate-950/90 border border-slate-200 dark:border-slate-800/90 rounded-2xl p-5 hover:border-emerald-500/40 shadow-sm transition">
            <span className="text-xs text-slate-500 dark:text-slate-400 font-mono block mb-1">
              ledger.lastVerificationHash
            </span>
            <div className="flex items-center gap-2">
              <span className="text-xs font-mono text-emerald-700 dark:text-emerald-400 break-all block leading-relaxed font-bold">
                {lastVerificationHash}
              </span>
              <button
                onClick={() => handleCopy(lastVerificationHash)}
                className="p-1.5 rounded-lg bg-slate-100 dark:bg-slate-900 hover:bg-slate-200 dark:hover:bg-slate-800 text-slate-500 hover:text-slate-900 dark:hover:text-white transition shrink-0"
              >
            ...
            <tbody className="divide-y divide-slate-200 dark:divide-slate-800 font-mono text-[11px]">
              {computations.map((item) => (
                <tr key={item.id} className="hover:bg-slate-100/50 dark:hover:bg-slate-800/40 transition">
                  ...
                  <td className="px-4 py-3 font-bold text-cyan-700 dark:text-cyan-300">
                    requestComputation()
                  </td>
                  <td className="px-4 py-3 text-slate-900 dark:text-slate-300 font-sans font-semibold">
                    {item.datasetName}
                  </td>
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-1.5">
                      ...
                      <button
                        ...
                        className="p-1 rounded hover:bg-slate-200 dark:hover:bg-slate-800 text-slate-400 hover:text-cyan-600 dark:hover:text-cyan-300 transition"
                      >
